...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { is_broadcasting: @batch.is_broadcasting, name: @batch.name } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { is_broadcasting: @batch.is_broadcasting, name: @batch.name } }
